...
needs pyre built with cuda, and cuda-python's {cuda.core}
"""
...
def main():
    ...
    # two managed grids
    rows, cols = 300, 500
    x = pyre.cuda.managed(shape=(rows, cols), cell="float64")
    y = pyre.cuda.managed(shape=(rows, cols), cell="float64")
