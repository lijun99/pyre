...
public:
    ...
    [[nodiscard]] PYRE_HOST_DEVICE constexpr auto offset(const index_type &) const noexcept
        -> difference_type;
    // the inverse map: the index of the cell that lives at the given offset
    [[nodiscard]] PYRE_HOST_DEVICE constexpr auto index(difference_type) const noexcept
        -> index_type;
    // syntactic sugar
    [[nodiscard]] PYRE_HOST_DEVICE constexpr auto operator[](const index_type &) const noexcept
        -> difference_type;
    [[nodiscard]] PYRE_HOST_DEVICE constexpr auto operator[](difference_type) const noexcept
        -> index_type;
